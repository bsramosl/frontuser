...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-12-2023 a las 05:03:34
...
(7, 'Uni Bar2', 9, '8:00 AM - 10:00 AM', '12:00 PM - 3:00 PM', '5:00 PM - 8:00 PM', NULL);
...
(148, 9, '2023-12-25 23:02:35', 'Pendiente', '2023122570', NULL),
(149, 9, '2023-12-25 23:15:22', 'Pendiente', '2023122528', NULL);
...
(1, 'Ubicacion1', '-239383.20', '-8861349.65'),
(5, 'Uni Bar2', '-239400.74170082717', '-8861456.65181555'),
(6, 'Uni Bar2', '-239400.74170082717', '-8861456.65181555'),
(7, 'Uni Bar2', '-239400.74170082717', '-8861456.65181555'),
(8, 'Uni Bar2', '-239400.74170082717', '-8861456.65181555'),
(9, 'Uni Bar2', '-239400.74170082717', '-8861456.65181555');
...
(1, 'admin', 'admin', 'Juan', 'Perez', '1234567890', 'juan@example.com', 'Dirección 123', '12345678', 1, 3),
(4, 'asd', 'asd', 'asd', 'asd', '', '', '', '', 1, 1),
(6, '1234', '1234', '1234', '1234', '', '', '', '', 1, 1),
(7, '1234', '', '123', '123', '1234', '1234', '1234', '1234', 1, 1),
(8, '123', '123', 'juan', 'lopez', NULL, '123', NULL, NULL, NULL, 1),
(9, 'marco', 'marco', 'marco', 'arreaga', NULL, '753', NULL, NULL, NULL, 2),
...
--
ALTER TABLE `bar`
  MODIFY `id_bar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `detalle_reserva`
  MODIFY `id_detalle_reserva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;

--
-- AUTO_INCREMENT de la tabla `empleado_bar`
--
ALTER TABLE `empleado_bar`
  MODIFY `id_empleado_bar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `reserva`
  MODIFY `id_reserva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
